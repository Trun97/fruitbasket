        ...
        <>
            ...
            <footer>
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="firstName" id="first-name" value={formState.firstName}
                           onChange={handleChange}/>
                    <br/>
                    <label htmlFor="last-name">Achternaam:</label>
                    <input type="text" name="lastName" id="last-name" value={formState.lastName}
                           onChange={handleChange}/>
                    <br/>
                    ...
                    <input type="text" name="postalCode" value={formState.postalCode} id="postal-code"
                           onChange={handleChange}/>
                    <br/>
                    <label htmlFor="deliver-freq">Bezorgfrequentie</label>
                    <select id="deliver-freq" name="deliverFrequency" value={formState.deliverFrequency}
                            onChange={handleChange}>
                    ...
                    <br/>
                    <label>
                        <input type="radio" name="timeSlot" value="Overdag" checked={formState.timeSlot === "Overdag"}
                               onChange={handleChange}/>
                        Overdag</label>
                    <label>
                        <input type="radio" name="timeSlot" value="'s Avonds"
                               checked={formState.timeSlot === "'s Avonds"} onChange={handleChange}/>
                        s Avonds</label>
                    <br/>
